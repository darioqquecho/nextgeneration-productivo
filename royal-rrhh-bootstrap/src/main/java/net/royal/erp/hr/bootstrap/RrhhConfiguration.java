...
import net.royal.erp.hr.application.maestros.parametro.mantenimiento.port.*;
...
import net.royal.erp.hr.infrastructure.maestros.parametro.jasper.JasperReporteParametrosDocumentGenerator;
import net.royal.erp.hr.infrastructure.maestros.parametro.oracle.OracleAprobacionMasivaParametrosV1Adapter;
import net.royal.erp.hr.infrastructure.maestros.parametro.oracle.OracleMantenimientoTablaParametrosV1Adapter;
import net.royal.erp.hr.infrastructure.maestros.parametro.oracle.OracleMantenimientoTablaParametrosV2Adapter;
import net.royal.erp.hr.infrastructure.maestros.parametro.oracle.OracleReporteParametrosV1Adapter;
import net.royal.erp.hr.infrastructure.maestros.parametro.sqlserver.SqlServerAprobacionMasivaParametrosV1Adapter;
import net.royal.erp.hr.infrastructure.maestros.parametro.sqlserver.SqlServerMantenimientoTablaParametrosV1Adapter;
import net.royal.erp.hr.infrastructure.maestros.parametro.sqlserver.SqlServerMantenimientoTablaParametrosV2Adapter;
import net.royal.erp.hr.infrastructure.maestros.parametro.sqlserver.SqlServerReporteParametrosV1Adapter;
import net.royal.erp.hr.infrastructure.seguridad.RestConsultaPermisoAdapter;
import net.royal.erp.hr.infrastructure.maestros.tiposeguro.inmemory.InMemoryTipoSeguroRepositoryAdapter;
import net.royal.erp.hr.infrastructure.maestros.tiposeguro.oracle.OracleMantenimientoTipoSeguroV1Adapter;
import net.royal.erp.hr.infrastructure.maestros.tiposeguro.sqlserver.SqlServerMantenimientoTipoSeguroV1Adapter;
...
public class RrhhConfiguration {
	...
	@Bean
	MantenimientoTablaParametrosV1UseCase mantenimientoTablaParametrosUseCase(FunctionalVersionResolver v,
			...
			AuditPort a) {
		MantenimientoTablaParametrosV1UseCase v1 = new MantenimientoTablaParametrosV1UseCase(
	...
	@Bean
	RegistrarCapacitacionV1UseCase registrarCapacitacionUseCase(FunctionalVersionResolver v, CapacitacionRepository r,
	...
	@Bean
	AprobarRequerimientoPersonalV1UseCase aprobarRequerimientoPersonalUseCase(FunctionalVersionResolver v,
