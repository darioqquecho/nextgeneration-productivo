...
class ParametroUseCaseTest {
	...
	void crearParametroOk() {
		...
		MantenimientoTablaParametrosUseCase useCase = new MantenimientoTablaParametrosV1UseCase(new InMemoryParametroRepositoryAdapter(),
	...
	void crearParametroVersionadoOk() {
		...
		MantenimientoTablaParametrosUseCase useCase = new MantenimientoTablaParametrosVersionedUseCase(resolver,
				new MantenimientoTablaParametrosV1UseCase(repository, guards, audit),
				new MantenimientoTablaParametrosV2UseCase(repository, guards, audit));
	...
	void listarParametrosConFiltrosOk() {
		...
		AuditPort audit = new ConsoleAuditAdapter();
		InMemoryParametroRepositoryAdapter repository = new InMemoryParametroRepositoryAdapter();
		MantenimientoTablaParametrosUseCase useCase = new MantenimientoTablaParametrosV1UseCase(repository, guards,
				audit);
	...
	void reporteParametrosPdfOk() {
		...
		MantenimientoTablaParametrosUseCase mantenimiento = new MantenimientoTablaParametrosV1UseCase(repository, guards,
				audit);
		ReporteParametrosUseCase reporte = new ReporteParametrosJasperUseCase(repository, guards, audit);
	...
	void aprobacionMasivaSoloCambiaDeAaAp() {
		...
		AprobacionMasivaParametrosUseCase useCase = new AprobacionMasivaParametrosV1UseCase(repository, guards, audit);
		FunctionalContext context = new FunctionalContext("default", "demo-client", "admin", "HR", "Maestros",
