...
/**
 * Implementa: - MOD-012 CU-001 EliminarParametro V2. - ARCH-010 Versionamiento Funcional.
 */
public class EliminarParametroV2UseCase extends EliminarParametroV1UseCase {
	public EliminarParametroV2UseCase(ParametroRepository repository, UseCaseGuards guards, AuditPort auditPort) {
