...
*/
@Entity
@Table(name = "CORREO_CUERPO",schema="SGALERTASSYS")public class CorreoCuerpo implements java.io.Serializable{

	private static final long serialVersionUID = 1L;
	@EmbeddedId
	private CorreoCuerpoPk pk;
	...
	public CorreoCuerpo() {
		pk = new CorreoCuerpoPk();
	}
	public CorreoCuerpo(byte[] cuerpoCorreo) {
		pk = new CorreoCuerpoPk();
		this.cuerpoCorreo=cuerpoCorreo;
	}

	public CorreoCuerpo(CorreoCuerpoPk pk) {
		this.pk = pk;
	}

	public CorreoCuerpoPk getPk() {
		return pk;
	}

	public void setPk(CorreoCuerpoPk pk) {
		this.pk = pk;
	}
	/**
	 *  
