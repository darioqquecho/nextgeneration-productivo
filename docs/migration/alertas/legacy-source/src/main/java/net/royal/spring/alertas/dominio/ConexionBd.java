...
*/
@Entity
@Table(name = "CONEXION_BD")
public class ConexionBd implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private ConexionBdPk pk;

	@Size(min = 0, max = 3)
	@Column(name = "ID_PROVEEDOR_BD", length = 3, nullable = true)
	...
	@Size(min = 0, max = 500)
	@Column(name = "CONEXION", length = 500, nullable = true)
	...
	public ConexionBd(ConexionBdPk pk) {
		this.pk = pk;
	}

	public ConexionBdPk getPk() {
		return pk;
	}

	public void setPk(ConexionBdPk pk) {
		this.pk = pk;
	}
	/**
	 *  
