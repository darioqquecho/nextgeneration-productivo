...
public class FrecuenciaMensual implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FrecuenciaMensualPk pk;
	...
	public FrecuenciaMensual() {
		pk = new FrecuenciaMensualPk();
	}


	public FrecuenciaMensual(FrecuenciaMensualPk pk) {
		this.pk = pk;
	}

	public FrecuenciaMensualPk getPk() {
		return pk;
	}

	public void setPk(FrecuenciaMensualPk pk) {
		this.pk = pk;
	}
	/**
	 *  
