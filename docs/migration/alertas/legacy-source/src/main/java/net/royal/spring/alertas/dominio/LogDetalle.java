...
public class LogDetalle implements java.io.Serializable{
	...
	@Size(min = 0, max = 300)
	@Column(name = "CLAVE_BUSQUEDA", length = 300, nullable = true)
	...
	public LogDetalle(LogDetallePk pk) {
		this.pk = pk;
	}

	public LogDetallePk getPk() {
		return pk;
	}

	public void setPk(LogDetallePk pk) {
		this.pk = pk;
	}
	/**
	 *  
