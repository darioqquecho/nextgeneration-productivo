...
*/
@Entity
@Table(name = "REGLA_NEGOCIO_DETALLE",schema = "SGALERTASSYS")
public class ReglaNegocioDetalle implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private ReglaNegocioDetallePk pk;
	...
	@Size(min = 0, max = 3)
	@Column(name = "ID_TIPO_DATO", length = 3, nullable = true)
	...
	@Size(min = 0, max = 250)
	@Column(name = "DESCRIPCION_CAMPO", length = 250, nullable = true)
	private String descripcionCampo;

	@Column(name = "LONGITUD_CAMPO", nullable = true)
	...
	@Size(min = 0, max = 1)
	@Column(name = "FLG_MOSTRAR_EN_CORREO", length = 1, nullable = true)
	...
	public ReglaNegocioDetalle() {
		pk = new ReglaNegocioDetallePk();
	}


	public ReglaNegocioDetalle(ReglaNegocioDetallePk pk) {
		this.pk = pk;
	}

	public ReglaNegocioDetallePk getPk() {
		return pk;
	}

	public void setPk(ReglaNegocioDetallePk pk) {
		this.pk = pk;
	}
	/**
	 *  
