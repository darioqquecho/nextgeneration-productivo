 ...
 * 
 * 
 * @tabla SGALERTASSYS.LOG_DETALLE
*/
public class LogDetallePk implements java.io.Serializable{
	...
	public LogDetallePk(Integer pidLogAlerta,Integer pnroRegistro,String pnombreCampo) {
