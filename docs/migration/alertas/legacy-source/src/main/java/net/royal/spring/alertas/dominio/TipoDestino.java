...
public class TipoDestino implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TipoDestinoPk pk;
	...
	public TipoDestino() {
		pk = new TipoDestinoPk();
	}


	public TipoDestino(TipoDestinoPk pk) {
		this.pk = pk;
	}

	public TipoDestinoPk getPk() {
		return pk;
	}

	public void setPk(TipoDestinoPk pk) {
		this.pk = pk;
	}
	/**
	 *  
