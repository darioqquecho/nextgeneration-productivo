...
*/
@Entity
@Table(name = "FUENTE_ALERTA")
public class FuenteAlerta implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FuenteAlertaPk pk;
	...
	public FuenteAlerta() {
		pk = new FuenteAlertaPk();
	}


	public FuenteAlerta(FuenteAlertaPk pk) {
		this.pk = pk;
	}

	public FuenteAlertaPk getPk() {
		return pk;
	}

	public void setPk(FuenteAlertaPk pk) {
		this.pk = pk;
	}
	/**
	 *  
