...
*/
@Entity
@Table(name = "FRECUENCIA_PROGRAMACION")
public class FrecuenciaProgramacion implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FrecuenciaProgramacionPk pk;
	...
	public FrecuenciaProgramacion() {
		pk = new FrecuenciaProgramacionPk();
	}


	public FrecuenciaProgramacion(FrecuenciaProgramacionPk pk) {
		this.pk = pk;
	}

	public FrecuenciaProgramacionPk getPk() {
		return pk;
	}

	public void setPk(FrecuenciaProgramacionPk pk) {
		this.pk = pk;
	}
	/**
	 *  
