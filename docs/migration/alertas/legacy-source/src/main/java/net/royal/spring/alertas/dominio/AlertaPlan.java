...
*/
@Entity
@Table(name = "ALERTA_PLAN",schema="SGALERTASSYS")
public class AlertaPlan implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private AlertaPlanPk pk;
	...
	public AlertaPlan(AlertaPlanPk pk) {
		this.pk = pk;
	}

	public AlertaPlanPk getPk() {
		return pk;
	}

	public void setPk(AlertaPlanPk pk) {
		this.pk = pk;
	}
	/**
	 *  
