...
*/
@Entity
@Table(name = "PERFIL_CORREO")
public class PerfilCorreo implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private PerfilCorreoPk pk;
	...
	@Size(min = 0, max = 1000)
	@Column(name = "PERFIL", length = 1000, nullable = true)
	...
	@Size(min = 0, max = 1)
	@Column(name = "FLG_PREDETERMINADO", length = 1, nullable = true)
	private String flgPredeterminado;
	...
	public PerfilCorreo() {
		pk = new PerfilCorreoPk();
	}


	public PerfilCorreo(PerfilCorreoPk pk) {
		this.pk = pk;
	}

	public PerfilCorreoPk getPk() {
		return pk;
	}

	public void setPk(PerfilCorreoPk pk) {
		this.pk = pk;
	}
	/**
	 *  
	...
	*/
	 ...
	 *  
	 * 
	 * @campo FLG_PREDETERMINADO
	*/
	public String getFlgPredeterminado() {
	 ...
	 * @campo FLG_PREDETERMINADO
	*/
	public void setFlgPredeterminado(String flgPredeterminado) {
