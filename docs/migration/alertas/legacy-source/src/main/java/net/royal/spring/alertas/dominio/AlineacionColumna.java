...
*/
@Entity
@Table(name = "ALINEACION_COLUMNA")
public class AlineacionColumna implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private AlineacionColumnaPk pk;
	...
	public AlineacionColumna() {
		pk = new AlineacionColumnaPk();
	}


	public AlineacionColumna(AlineacionColumnaPk pk) {
		this.pk = pk;
	}

	public AlineacionColumnaPk getPk() {
		return pk;
	}

	public void setPk(AlineacionColumnaPk pk) {
		this.pk = pk;
	}
	/**
	 *  
