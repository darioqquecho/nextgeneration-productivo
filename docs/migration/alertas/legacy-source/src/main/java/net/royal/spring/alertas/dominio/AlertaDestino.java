...
*/
@Entity
@Table(name = "ALERTA_DESTINO",schema="SGALERTASSYS")
public class AlertaDestino implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private AlertaDestinoPk pk;

	@Size(min = 0, max = 200)
	@Column(name = "CORREO_DESTINO", length = 200, nullable = true)
	...
	public AlertaDestino() {
		pk = new AlertaDestinoPk();
	}


	public AlertaDestino(AlertaDestinoPk pk) {
		this.pk = pk;
	}

	public AlertaDestinoPk getPk() {
		return pk;
	}

	public void setPk(AlertaDestinoPk pk) {
		this.pk = pk;
	}
	/**
	 *  
