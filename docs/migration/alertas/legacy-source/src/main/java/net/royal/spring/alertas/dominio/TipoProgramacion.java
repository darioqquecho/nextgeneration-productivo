...
public class TipoProgramacion implements java.io.Serializable{
	...
	public TipoProgramacion() {
		pk = new TipoProgramacionPk();
	}


	public TipoProgramacion(TipoProgramacionPk pk) {
		this.pk = pk;
	}

	public TipoProgramacionPk getPk() {
		return pk;
	}

	public void setPk(TipoProgramacionPk pk) {
		this.pk = pk;
	}
	/**
	 *  
