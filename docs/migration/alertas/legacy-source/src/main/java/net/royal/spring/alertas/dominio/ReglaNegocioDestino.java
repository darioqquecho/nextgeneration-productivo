...
*/
@Entity
@Table(name = "REGLA_NEGOCIO_DESTINO",schema = "SGALERTASSYS")
public class ReglaNegocioDestino implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private ReglaNegocioDestinoPk pk;
	...
	@Size(min = 0, max = 500)
	@Column(name = "GRUPO_CORREO", length = 500, nullable = true)
	...
	public ReglaNegocioDestino() {
		pk = new ReglaNegocioDestinoPk();
	}


	public ReglaNegocioDestino(ReglaNegocioDestinoPk pk) {
		this.pk = pk;
	}

	public ReglaNegocioDestinoPk getPk() {
		return pk;
	}

	public void setPk(ReglaNegocioDestinoPk pk) {
		this.pk = pk;
	}
	/**
	 *  
