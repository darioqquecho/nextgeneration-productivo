...
*/
@Entity
@Table(name = "FUENTE_ALERTA_ADICIONAL")
public class FuenteAlertaAdicional implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FuenteAlertaAdicionalPk pk;
	...
	public FuenteAlertaAdicional() {
		pk = new FuenteAlertaAdicionalPk();
	}


	public FuenteAlertaAdicional(FuenteAlertaAdicionalPk pk) {
		this.pk = pk;
	}

	public FuenteAlertaAdicionalPk getPk() {
		return pk;
	}

	public void setPk(FuenteAlertaAdicionalPk pk) {
		this.pk = pk;
	}
	/**
	 *  
