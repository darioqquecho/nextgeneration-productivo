...
public class ProveedorBd implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private ProveedorBdPk pk;
	...
	public ProveedorBd() {
		pk = new ProveedorBdPk();
	}


	public ProveedorBd(ProveedorBdPk pk) {
		this.pk = pk;
	}

	public ProveedorBdPk getPk() {
		return pk;
	}

	public void setPk(ProveedorBdPk pk) {
		this.pk = pk;
	}
	/**
	 *  
