...
*/
@Entity
@Table(name = "AREA_NEGOCIO",schema="SGALERTASSYS")
public class AreaNegocio implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private AreaNegocioPk pk;
	...
	public AreaNegocio() {
		pk = new AreaNegocioPk();
	}


	public AreaNegocio(AreaNegocioPk pk) {
		this.pk = pk;
	}

	public AreaNegocioPk getPk() {
		return pk;
	}

	public void setPk(AreaNegocioPk pk) {
		this.pk = pk;
	}
	/**
	 *  
