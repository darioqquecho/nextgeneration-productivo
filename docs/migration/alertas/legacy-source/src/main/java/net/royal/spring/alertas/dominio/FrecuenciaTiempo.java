...
*/
@Entity
@Table(name = "FRECUENCIA_TIEMPO")
public class FrecuenciaTiempo implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FrecuenciaTiempoPk pk;
	...
	public FrecuenciaTiempo() {
		pk = new FrecuenciaTiempoPk();
	}


	public FrecuenciaTiempo(FrecuenciaTiempoPk pk) {
		this.pk = pk;
	}

	public FrecuenciaTiempoPk getPk() {
		return pk;
	}

	public void setPk(FrecuenciaTiempoPk pk) {
		this.pk = pk;
	}
	/**
	 *  
