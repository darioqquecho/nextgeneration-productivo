...
*/
@Entity
@Table(name = "LOG_ADICIONAL")
public class LogAdicional implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private LogAdicionalPk pk;
	...
	public LogAdicional() {
		pk = new LogAdicionalPk();
	}


	public LogAdicional(LogAdicionalPk pk) {
		this.pk = pk;
	}

	public LogAdicionalPk getPk() {
		return pk;
	}

	public void setPk(LogAdicionalPk pk) {
		this.pk = pk;
	}
	/**
	 *  
