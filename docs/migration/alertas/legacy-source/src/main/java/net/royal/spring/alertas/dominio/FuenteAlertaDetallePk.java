...
*/
public class FuenteAlertaDetallePk implements java.io.Serializable{
	...
	public FuenteAlertaDetallePk() {
	}

	public FuenteAlertaDetallePk(Integer pidFuenteAlerta,Integer pnroRegistro,String pcampoNombre) {
