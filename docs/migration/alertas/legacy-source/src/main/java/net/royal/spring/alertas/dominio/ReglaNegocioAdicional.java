...
*/
@Entity
@Table(name = "REGLA_NEGOCIO_ADICIONAL",schema = "SGALERTASSYS")
public class ReglaNegocioAdicional implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private ReglaNegocioAdicionalPk pk;
	...
	public ReglaNegocioAdicional() {
		pk = new ReglaNegocioAdicionalPk();
	}


	public ReglaNegocioAdicional(ReglaNegocioAdicionalPk pk) {
		this.pk = pk;
	}

	public ReglaNegocioAdicionalPk getPk() {
		return pk;
	}

	public void setPk(ReglaNegocioAdicionalPk pk) {
		this.pk = pk;
	}
	/**
	 *  
