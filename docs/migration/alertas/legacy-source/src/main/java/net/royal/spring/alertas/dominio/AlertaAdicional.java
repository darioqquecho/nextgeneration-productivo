...
*/
@Entity
@Table(name = "ALERTA_ADICIONAL",schema="SGALERTASSYS")
public class AlertaAdicional implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private AlertaAdicionalPk pk;
	...
	public AlertaAdicional() {
		pk = new AlertaAdicionalPk();
	}


	public AlertaAdicional(AlertaAdicionalPk pk) {
		this.pk = pk;
	}

	public AlertaAdicionalPk getPk() {
		return pk;
	}

	public void setPk(AlertaAdicionalPk pk) {
		this.pk = pk;
	}
	/**
	 *  
