 ...
 *
 * Propósito: Caso de uso migrado para operación Obtener Registro.
 */
public class ObtenerRegistroUseCase implements UseCase<AlertasIdCommand, AlertasOperationResult> {
	private final AlertasRecordRepository repository;
	private final AlertasUseCaseGuards guards;
	private final AuditPort auditPort;

	public ObtenerRegistroUseCase(AlertasRecordRepository repository, AlertasUseCaseGuards guards,
			AuditPort auditPort) {
	...
	/**
	 * Ejecuta operación Obtener Registro en SQL Server mediante puerto de dominio.
	 *
