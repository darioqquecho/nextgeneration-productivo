 ...
 *
 * Propósito: Caso de uso migrado para operación Eliminar Registro.
 */
public class EliminarRegistroUseCase implements UseCase<AlertasIdCommand, AlertasOperationResult> {
	private final AlertasRecordRepository repository;
	private final AlertasUseCaseGuards guards;
	private final AuditPort auditPort;

	public EliminarRegistroUseCase(AlertasRecordRepository repository, AlertasUseCaseGuards guards,
			AuditPort auditPort) {
	...
	/**
	 * Ejecuta operación Eliminar Registro en SQL Server mediante puerto de dominio.
	 *
