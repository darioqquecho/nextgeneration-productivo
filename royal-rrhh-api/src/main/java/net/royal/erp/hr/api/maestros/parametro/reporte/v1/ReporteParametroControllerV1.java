...
import net.royal.erp.hr.application.maestros.parametro.reporte.dto.ReporteParametrosResult;
...
public class ReporteParametroControllerV1 extends RoyalBaseController {
	...
	public ResponseEntity<byte[]> reportePdf(@Valid @RequestBody(required = false) ReporteParametrosRequestV1 request,
		...
		ReporteParametrosResult result = reporte.ejecutar(ReporteParametroApiV1Mapper.toQuery(request),
